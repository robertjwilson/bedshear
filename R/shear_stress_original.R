...
double ustar, Ren, TcS, TcS_cr;
          g = 9.81;                // acceleration due to gravity (ms-2)
            ...
            Ren = (ustar)*D/kinv;              // Reynolds particle number
            TcS = tmax/((sed-swd)*g*D);           // Shields stress
